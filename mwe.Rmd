...
\begin{itemize}
  ...
  \item $p$: number of covariates without intercept
  \item inf: number of informative covariates $p=$ inf $+$ noninf
  \item n_pred: number of observations for prediction after estimation (testing)
  \item NSR: Noise-to-signal ratio
  \item cor: correlation structure
  \item fam: family of distribution
